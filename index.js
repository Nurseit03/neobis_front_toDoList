...
function addTask() {
  ...
  if (text.length === 0) {
    ...
    newTask.innerHTML = `<p class="task__item__text">${text}</p>`;
...
// const itemPersonal = document.createElement("button");
// itemPersonal.className="task__list__item--personal";
// newTask.insertAdjacentHTML('beforebegin', itemPersonal)

// const itemBusiness = document.createElement("button");
// itemBusiness.className="task__list__item--business";
// newTask.insertAdjacentHTML('beforebegin', itemBusiness)
